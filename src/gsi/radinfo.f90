...
! set passed variables to public
  ...
  public :: crtm_overlap,rewopt,reiopt,allsky_gfdl,allsky_verbose
...
! CCH
  public :: situ_oberr_infla_all, situ_oberr_infla_only_scatter_wind
  public :: channel_sensitivity_test
  public :: ng_error_amsua, ng_error_atms, io_cloud_bc_amsua, io_cloud_bc_atms
  public :: io_ng_table_interp
  public :: predictor_amsua, predictor_atms
  public :: save_radjac_anyway
  public :: every_5th_scan_atms
...
!                                                          certain instruments. Set to greater than zero to use  
  ...
  integer(i_kind) :: crtm_overlap
  integer(i_kind) :: rewopt, reiopt
  logical :: allsky_gfdl,allsky_verbose

! CCH
  logical :: situ_oberr_infla_all, situ_oberr_infla_only_scatter_wind
  logical :: ng_error_amsua, ng_error_atms, io_cloud_bc_amsua, io_cloud_bc_atms
  logical :: io_ng_table_interp
  logical :: save_radjac_anyway
  logical :: every_5th_scan_atms
  character(len=30):: predictor_amsua, predictor_atms
  character(len=20):: channel_sensitivity_test
...
! CCH
    situ_oberr_infla_all               = .true.  ! situation-dependent obs error inflation for amsua, atms (zhu2016)
    situ_oberr_infla_only_scatter_wind = .false. ! only use the scattering and wind criteria for obs error inflation
    channel_sensitivity_test = 'None' ! channel sensitivity test for the all-sky amsua/atms channels
                                      ! None     = no test
                                      ! amsua_1  = only turn off SDOEI for amusa ch1 and atms ch1
                                      ! amsua_2  = amsua ch2 + atms ch2
                                      ! amsua_3  = amsua ch3 + atms ch3
                                      ! amsua_4  = amsua ch4 + atms ch5
                                      ! atms_4   = atms ch4
                                      ! amsua_5  = amsua ch5 + atms ch6
                                      ! amsua_15 = amsua ch15 + atms ch16
                                      ! atms_17  = atms ch17
                                      ! atms_18  = atms ch18
                                      ! atms_19  = atms ch19
                                      ! atms_20  = atms ch20
    ...
    ng_error_amsua = .false.  ! true = non-Gaussian error; false = original cloud-depednent error
    ng_error_atms  = .false.  ! true = non-Gaussian error; false = original cloud-depednent error
    io_cloud_bc_amsua = .false. ! if false, then the mode of the non-Gaussian observation error pdf will be re-centered at zero
    io_cloud_bc_atms  = .false. ! if false, then the mode of the non-Gaussian observation error pdf will be re-centered at zero
    io_ng_table_interp = .false. ! if true, will use interpolated stdev between the discretized cloud bins
    predictor_amsua = 'sym_cld' ! the predictor for obs error model for AMSUA. Currently available: 'sym_cld', 'obs_cld', 'no_pred'
    predictor_atms  = 'sym_cld' ! the predictor for obs error model for ATMS.  Currently available: 'sym_cld', 'obs_cld', 'no_pred'
    save_radjac_anyway = .false. ! if true, then save the radiance jacobian for AMSU-A and ATMS (regardless of which mode is used)
    every_5th_scan_atms = .false. ! if true, then ONLY use every 5th scan position data for ATMS assimilation
